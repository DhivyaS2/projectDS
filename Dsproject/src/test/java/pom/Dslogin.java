...
public void user(String sheetname) throws IOException {
	...
	FileInputStream exc= new FileInputStream(".//src/test/resources/Excel/"+sheetname+".xlsx");
...
public WebDriver signin() throws IOException {
	
	FileInputStream exc= new FileInputStream(".//src/test/resources/Excel/login.xlsx");
	XSSFWorkbook work= new XSSFWorkbook(exc);
	XSSFSheet sheet =work.getSheetAt(0);
	int row= sheet.getLastRowNum();
	String pwd;
